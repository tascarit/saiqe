...
def on_start(self, name, passw):
    ...
    if platform.system() == "Linux":
        file = open('/home/{}/Saiqe/avatar.png'.format(getpass.getuser()), "w+b")
        while True:
        ...
        avatar = ImageTk.PhotoImage(Image.open('/home/{}/Saiqe/avatar.png'.format(getpass.getuser())).resize((65, 65)), Image.ANTIALIAS)

    elif platform.system() == "Windows":
        file = open('{}/Users/{}/ProgramData/Saiqe/avatar.png'.format(os.getenv("SystemDrive"), getpass.getuser()), "w+b")
        while True:
        ...
        avatar = ImageTk.PhotoImage(Image.open('{}/Users/{}/ProgramData/Saiqe/avatar.png'.format(os.getenv("SystemDrive"), getpass.getuser())).resize((65, 65)), Image.ANTIALIAS)
    ...
    if platform.system() == "Linux":
        file = open('/home/{}/Saiqe/settings.png'.format(getpass.getuser()), "w+b")
        while True:
        ...
        settings_image = ImageTk.PhotoImage(Image.open('/home/{}/Saiqe/settings.png'.format(getpass.getuser())))

    elif platform.system() == "Windows":
        file = open('{}/Users/{}/ProgramData/Saiqe/settings.png'.format(os.getenv("SystemDrive"), getpass.getuser()), "w+b")
        while True:
        ...
        settings_image = ImageTk.PhotoImage(Image.open('{}/Users/{}/ProgramData/Saiqe/settings.png'.format(os.getenv("SystemDrive"), getpass.getuser())))
    ...
    def on_settings_open():
        ...
        if settings_open == 0:
            ...
            def on_image_open():
                ...
                if platform.system() == "Linux":
                    path = '/home/{}/Saiqe/avatar.png'.format(getpass.getuser())
                    file = open(path, "w+b")
                    ...
                    path = '{}/Users/{}/ProgramData/Saiqe/avatar.png'.format(os.getenv("SystemDrive"), getpass.getuser())
                    file = open(path, "w+b")
                    file.write(full_data)
                    file.close()
